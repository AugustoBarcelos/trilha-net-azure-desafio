...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        funcionarioBanco.Ramal = funcionario.Ramal; // Atualize as outras propriedades conforme necessário
        // TODO: Atualize as outras propriedades conforme necessário
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.SaveChanges(); // Remove do Banco SQL
